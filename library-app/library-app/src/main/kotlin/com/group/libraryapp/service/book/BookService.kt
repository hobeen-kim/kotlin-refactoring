...
import com.group.libraryapp.repository.user.userhistory.UserLoanHistoryQuerydslRepository
...
class BookService(
    ...
    fun loanBook(request: BookLoanRequest) {
        ...
        userLoanHistoryRepository.save(UserLoanHistory(user, book.name))
    }
